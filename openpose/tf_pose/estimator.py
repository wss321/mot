...
class Human:
    ...
    def get_face_box(self, img_w, img_h, mode=1):
        """
    ...
    def get_upper_body_box(self, img_w, img_h, mode=1):
        """
...
class TfPoseEstimator:
    ...
    def __init__(self, graph_path, target_size=(320, 240), tf_config=None):
        ...
        with self.persistent_sess.as_default():
            with self.persistent_sess.graph.as_default():
                tf.import_graph_def(graph_def, name='TfPoseEstimator')
                self.graph = self.persistent_sess.graph
